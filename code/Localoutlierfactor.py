...
clf = LocalOutlierFactor(n_neighbors=5, contamination=0.05)#18 98.5422 72.2222
# clf = LocalOutlierFactor(n_neighbors=35, contamination=0.005)#4 075 1
cc=tr_data[['is','power']]
clf.fit(cc)
pred = clf.fit_predict(cc)
